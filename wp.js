...
function build(){
 ...
 var dh='';
 DOK.forEach(function(o,i){var tr=o.t[lang]||o.t.da;var forvalgt=(i===0||o.fil)?' checked':'';dh+='<label class="lwp-c"><input type="checkbox" class="lwp-dok" data-v="'+esc(o.v)+'"'+forvalgt+'> <span><b>'+esc(tr[0])+'</b> - '+esc(tr[1])+'</span></label>';});
